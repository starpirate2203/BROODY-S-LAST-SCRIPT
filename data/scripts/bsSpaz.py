...
class Spaz(bs.Actor):
    ...
    def __init__(self, color=(1, 1, 1), highlight=(0.5, 0.5, 0.5), character="Spaz", sourcePlayer=None, startInvincible=False, canAcceptPowerups=True, powerupsExpire=False, demoMode=False):
