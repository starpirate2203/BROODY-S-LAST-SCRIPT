    ...
    def _readEntries(self):
        ...
        try:
            ...
            class SpawnSpaz(object):
                def __init__(self,num,position,color=(1,1,1), highlight = (1,1,1), character="Spaz", makeCurrent=False,relativeTo=None,name='',flash=True, angle=0):
                    self._num = num
            ...
            self._entries = [Reset(),
                             SpawnSpaz(0,(0,5.5,-3.0),makeCurrent=True, color = (10,5,2), character="Snake Shadow"), 
                             DelayOld(1000),
                             ...
                             Move(0,0),
                             DelayOld(1000),
                             Text(bs.Lstr(resource=self._r+'.phrase05Text')), 
                             DelayOld(510),
                             Move(0,-0.01),
                             DelayOld(100),
                             Move(0,0),
                             ...
                             SpawnSpaz(0,(-0.09249162673950195, 4.337906360626221, -2.3), makeCurrent=True, flash=False, character="Snake Shadow", color = (10,5,2)),
                             SpawnSpaz(1,(-3.1, 4.3, -2.0),makeCurrent=False,flash=False, character="Grumbledorf", color = (-5,-5,-5), highlight = (8,8,0), 
                             ...
                             Move(0,0),
                             DelayOld(1000),
                             Text(bs.Lstr(resource=self._r+'.phrase06Text')), 
                             DelayOld(1200),
                             Move(-0.05,0),
                             DelayOld(200),
                             Punch(),
                             ...
                             SpawnSpaz(0,(-3.2, 4.3, -4.4),makeCurrent=True,flash=False, character="Pascal", color = (-1,-1,-1), highlight = (1,1,1),
                                       name=bs.Lstr(resource=self._r+'.randomName2Text')),
                             SpawnSpaz(1,(3.3, 4.2, -5.8),makeCurrent=False,color=(-5, 1, -5), character = "Spaz"),
                             DelayOld(1800),
                             Text(bs.Lstr(resource=self._r+'.phrase11Text')), 
                             DelayOld(300),
                             ...
                             SpawnSpaz(0,(2.368781805038452, 4.337533950805664, -4.360159873962402),makeCurrent=True,flash=False, character="Snake Shadow", color = (10,5,2)),
                             SpawnSpaz(1,(-3.2, 4.3, -4.5),makeCurrent=False,color=(2, 2, 20), highlight = (-2,-2,-2), character = "Snake Shadow", #logo
                             ...
                             SpawnSpaz(0,(-4.0, 4.3, -2.5),makeCurrent=True,flash=False,angle=90, character="Snake Shadow", color = (10,5,2)),
                             SpawnSpaz(1,(5,0,-1.0),relativeTo=0,makeCurrent=False,color=(4,10,7),
                             ...
                             SpawnSpaz(0,(1.5, 4.3, -4.0),makeCurrent=True,flash=False,angle=0, character="Snake Shadow", color = (10,5,2)),
            ...
            DelayOld2(10),MoveLR(-0.70983),JumpRelease(),DelayOld2(30),MoveLR(-0.592181),MoveUD(-0.0588092),DelayOld2(10),MoveLR(-0.490219),MoveUD(-0.0744957),DelayOld2(10),MoveLR(-0.41963),DelayOld2(20),MoveLR(0),MoveUD(0),DelayOld2(20),MoveUD(0),
                             ...
                             SpawnSpaz(0,(-0.7, 4.3, -3.9),makeCurrent=True,flash=False,angle=-30, character = "Snake Shadow", color = (10,5,2)),
                             SpawnSpaz(1,(6.5,0,-0.75),relativeTo=0,makeCurrent=False,color=(3,8,10),
