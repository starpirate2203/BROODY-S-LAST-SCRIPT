...
values = {
    ...
    'lastSavedMessages':'Get Saved Chat Messages',
    'clearSavedMessages':'Clear Saved Chat Messages',
    ...
    'achievements':{
        ...
        'The Legendary Ball':{
            ...
            'descriptionComplete':'Legendary ball is founded',
            'descriptionFull':'Secret conditions.',
            'descriptionFullComplete':'U found ball))0)',
            'name':'The Legendary Ball'
        },
        'Runaround God':{
    ...
    'modpackSettingsWindow':{
        'titleText':'ModPack Settings',
        'admPrefixText':'Admin(host) Prefix',
        'playerEffectTimerText':'Player Effect Timer',
        'uiGameText':'Name of a game(match)',
        'powerupLightText':'Power-up\'s Light',
        'powerupTimerText':'Power-up\'s Timer',
        'bombTimerText':'Colored Indicator of Bomb Explosion',
        'deleteModPackText':'Delete ModPack',
        'newServerUIText':'Updated Lobby'
    },
    'serverInfo':{
        'enter':'Enter',
        'get':'Info',
    ...
    'sessionSettingsWindow':{
        ...
        'titleText':'Session Settings',
        'standartTime':'Standart Time',
        'sunriseTime':'Sunrise',
        'dayTime':'Day',
        'noonTime':'Noon',
        'sunsetTime':'Sunset',
    ...
    'helpWindow':{
        ...
        'powerupPunchDescriptionText':('Makes your punches harder,\n'
                                       'better, fastest, stronger.'),
        'powerupUnbreakableNameText':'Serenity',
        'powerupUnbreakableDescriptionText':('Reduces the part of incoming damage.'),
        'powerupPandoraBoxDescriptionText':('Can do anything what you want.\n'
                                    'Maybe not.'),
        'powerupPandoraBoxNameText':'Pandora\'s-Box',
        ...
        'powerupYellowShieldDescriptionText':('Saves you from poison.'),
        'powerupYellowShieldNameText':'Upgraded-Shield',
        'powerupTpBombsDescriptionText':('Sends opponents far away\n'
                                          'from you.'),
        'powerupTpBombsNameText':'Teleport-Bombs',
        'powerupKillLaKillBombsDescriptionText':('Much more powerful than \nusual bombs.'),
        'powerupKillLaKillBombsNameText':'Heavy-Bombs',
        'powerupFireworkBombsDescriptionText':('Seems to be safe?'),
        'powerupFireworkBombsNameText':'Firework',
        'powerupPoisonBombsDescriptionText':('Poison\'s your opponents.'),
        'powerupPoisonBombsNameText':'Poison-Bombs',
        'powerupJumpingBombsDescriptionText':('Weaker than usual bombs, \n'
                                             'but can jumps.'),
        'powerupJumpingBombsNameText':'Rebounding-Bombs',
        'powerupDirtBombsDescriptionText':('Summon a swamp on the floor, \n'
                                             'that can make your \nenemies slowly.'),
        'powerupDirtBombsNameText':'Dirty-Bombs',
        'powerupMultiBombsDescriptionText':('As the name implies,\n'
                               'an unlimited supply of bombs.'),
        'powerupMultiBombsNameText':'Infinity-Bombs',
        'powerupSpeedPunchDescriptionText':('Make you feel like\n'
                                                'an avid fan of Chuck Norris.'),
        'powerupSpeedPunchNameText':'Speedy Punches',
    ...
    'spaceKeyText':'space',
    'store':{
        'partiesFounded': 'Sercers founded: ',
        'searchCounts': 'Search counts: ',
